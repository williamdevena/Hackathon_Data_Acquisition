...
def solve_task3_1():
    ...
    store_collection_into_db(
        CLUSTER_NAME, DATABASE_NAME, COLLECTION_NAME_JAX_ISSUES, data
    )
    collection = read_collection(
        CLUSTER_NAME, DATABASE_NAME, COLLECTION_NAME_JAX_ISSUES
    )
...
def solve_task3_2():
    ...
    print(type(comments))
    lambda_sorter = (
        lambda dict: dict["reactions"]["hooray"]
        + dict["reactions"]["heart"]
        + dict["reactions"]["rocket"]
    )
